...
ThemeService.ɵfac = function ThemeService_Factory(ɵt) {
  return new (ɵt || ThemeService)();
};
...
BaseChartDirective.ɵfac = function BaseChartDirective_Factory(ɵt) {
  return new (ɵt || BaseChartDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ThemeService));
};
...
NgChartsConfiguration.ɵfac = function NgChartsConfiguration_Factory(ɵt) {
  return new (ɵt || NgChartsConfiguration)();
};
...
NgChartsModule.ɵfac = function NgChartsModule_Factory(ɵt) {
  return new (ɵt || NgChartsModule)(ɵɵinject(NgChartsConfiguration, 8));
};
